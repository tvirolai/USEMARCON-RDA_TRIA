...
my $inputfile = ReadData ("tekijanfunktiot.xlsx") || die $!;
my $outputfile = "Tekijanfunktiot2.tbl"; # An example
my $preamble = "Tekijanfunktiot.tbl -- Tekijän funktiotermien lyhenteiden avaus"; # An example
my $default_value = "COPY"; # COPY copies input value to output as is, if value is not found in Look Up Table

my $sheet = "2";
my $inputvalue_firstcell = "C2";
my $inputvalue_lastcell = "C32";
my $outputvalue_firstcell = "A2";
my $outputvalue_lastcell = "A32";
